...
(3) /images: two sample images from the PRiD450s database, used to demonstrate the feature extraction.

(4) /data: the extracted color_texture,LOMO,GOG features for the PRiD450s databases. Due to the size of the feature files, they are provided as separate downloads.https://pan.baidu.com/s/191LjPOKl2RSmU3RceIP15g
